...
export const quotationService = {
    ...
    async replyToRequest(id: number, data: { items?: any[], message: string, mode?: 'create' | 'upload', file?: File, vat?: number, includePdf?: boolean, terms?: string[] }): Promise<any> {
    ...
    async sendDirectQuote(data: { name: string, email: string, phone: string, items?: any[], message: string, mode?: 'create' | 'upload', file?: File, vat?: number, terms?: string[] }): Promise<any> {
        let config = {};
        let body: any = data;
