...
export default function AdminLayout({
    ...
    const menuItems = [
        ...
        { name: 'Quotation Requests', icon: FileText, href: '/dashboard/quotations' },

        // ── ERP Modules ──
        { name: 'Clients', icon: Users, href: '/dashboard/clients' },
        { name: 'POS / Billing', icon: Package, href: '/dashboard/pos' }, // Added POS
        { name: 'Invoices', icon: FileText, href: '/dashboard/invoices' }, // Added Invoices
        { name: 'Inventory', icon: Package, href: '/dashboard/inventory' }, // Added Inventory
        { name: 'Installations', icon: Wrench, href: '/dashboard/installations' }, // Added Installations
        { name: 'Service Logs', icon: FileText, href: '/dashboard/service-logs' }, // Added Service Logs
        { name: 'Warranty Check', icon: Search, href: '/dashboard/warranty' }, // Added Warranty Check
        { name: 'Reports', icon: LayoutDashboard, href: '/dashboard/reports' }, // Added Reports

        // ── CMS Modules ──
        { name: 'Projects Management', icon: FolderPlus, href: '/dashboard/projects' },
        { name: 'Products Management', icon: Package, href: '/dashboard/products' },
        { name: 'Brands Management', icon: LayoutGrid, href: '/dashboard/brands' },
        { name: 'Services Management', icon: Wrench, href: '/dashboard/services' },
